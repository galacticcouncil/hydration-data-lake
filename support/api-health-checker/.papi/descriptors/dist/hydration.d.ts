...
type IStorage = {
    ...
    Uniques: {
         ...
         */
        ClassAccount: StorageDescriptor<Anonymize<I95l2k9b1re95f>, null, true, never>;
        /**
    ...
    Dispatcher: {
         ...
         */
        ExtraGas: StorageDescriptor<[], bigint, false, never>;
    };
    AssetRegistry: {
        /**
         * Details of an asset.
    ...
    TransactionPause: {
         ...
         */
        PausedTransactions: StorageDescriptor<[Key: Anonymize<Idkbvh6dahk1v7>], null, true, never>;
    };
    Duster: {
        /**
         * Accounts excluded from dusting.
         */
        AccountBlacklist: StorageDescriptor<[Key: SS58String], null, true, never>;
        /**
    ...
    EVMAccounts: {
         ...
         */
        ApprovedContract: StorageDescriptor<[Key: FixedSizeBinary<20>], null, true, never>;
    };
    DynamicEvmFee: {
        /**
         * Base fee per gas
    ...
    DCA: {
         ...
         */
        ScheduleOwnership: StorageDescriptor<Anonymize<I6ouflveob4eli>, null, true, never>;
        /**
    ...
    Broadcast: {
         ...
         */
        Swapper: StorageDescriptor<[], SS58String, true, never>;
    };
};
type ICalls = {
    System: {
...
type IConstants = {
    ...
    CollatorRewards: {
         ...
         */
        RewardsBag: PlainDescriptor<SS58String>;
    };
    Omnipool: {
        /**
         * Native Asset ID
    ...
    Currencies: {
         ...
         */
        ReserveAccount: PlainDescriptor<SS58String>;
        /**
    ...
    EmaOracle: {
         ...
         */
        MaxAllowedPriceDifference: PlainDescriptor<number>;
        /**
...
type IRuntimeCalls = {
    ...
    ChainlinkAdapterApi: {
         ...
         */
        encode_oracle_address: RuntimeDescriptor<[asset_id_a: number, asset_id_b: number, period: Anonymize<I9m0752cdvui5o>, source: FixedSizeBinary<8>], FixedSizeBinary<20>>;
        /**
        
         */
        decode_oracle_address: RuntimeDescriptor<[oracle_address: FixedSizeBinary<20>], Anonymize<Ic0hbkpnq21991>>;
    };
    /**
