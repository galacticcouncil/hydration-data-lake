...
let CryptoUtils = (() => {
    ...
    var CryptoUtils = class {
        ...
        static {
            ...
            CryptoUtils = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        constructor() { }
        isEvmAddress(maybeAddress) {
            if (!maybeAddress)
                return false;
            try {
        ...
        isSubstrateAddress(maybeAddress) {
            if (!maybeAddress)
                return false;
            try {
        ...
        substrateAddressToHex(address) {
            const publicKey = decodeAddress(address);
            return u8aToHex(publicKey);
        }
    };
    return CryptoUtils = _classThis;
})();
export { CryptoUtils };
