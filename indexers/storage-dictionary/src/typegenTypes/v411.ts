...
export type Type_93 = Type_93_Member | Type_93_Members | Type_93__Phantom

export interface Type_93_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_93_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_93__Phantom {
    __kind: '_Phantom'
}
...
export type Type_96 = Type_96_Response | Type_96_Xcm

export interface Type_96_Response {
    __kind: 'Response'
    value: V5Location
}

export interface Type_96_Xcm {
    __kind: 'Xcm'
    value: V5Location
}
...
export interface Origin_OmnipoolAdmin {
    __kind: 'OmnipoolAdmin'
}
...
export interface Origin_Spender {
    __kind: 'Spender'
}

export interface Origin_Tipper {
    __kind: 'Tipper'
}
...
export type Type_95 = Type_95_EthereumTransaction

export interface Type_95_EthereumTransaction {
...
export type Type_112 = Type_112_Relay | Type_112_SiblingParachain

export interface Type_112_Relay {
    __kind: 'Relay'
}

export interface Type_112_SiblingParachain {
...
export type OriginCaller = OriginCaller_CumulusXcm | OriginCaller_Ethereum | OriginCaller_Origins | OriginCaller_PolkadotXcm | OriginCaller_TechnicalCommittee | OriginCaller_system
...
export const Call: sts.Type<Call> = sts.closedEnum(() => {
    return  {
        ...
        MultiBlockMigrations: MultiBlockMigrationsCall,
...
export const XYKLiquidityMiningCall: sts.Type<XYKLiquidityMiningCall> = sts.closedEnum(() => {
    return  {
        add_liquidity_and_join_farms: sts.enumStruct({
            assetA: sts.number(),
            assetB: sts.number(),
            amountA: sts.bigint(),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type XYKLiquidityMiningCall = XYKLiquidityMiningCall_add_liquidity_and_join_farms | XYKLiquidityMiningCall_claim_rewards | XYKLiquidityMiningCall_create_global_farm | XYKLiquidityMiningCall_create_yield_farm | XYKLiquidityMiningCall_deposit_shares | XYKLiquidityMiningCall_exit_farms | XYKLiquidityMiningCall_join_farms | XYKLiquidityMiningCall_redeposit_shares | XYKLiquidityMiningCall_resume_yield_farm | XYKLiquidityMiningCall_stop_yield_farm | XYKLiquidityMiningCall_terminate_global_farm | XYKLiquidityMiningCall_terminate_yield_farm | XYKLiquidityMiningCall_update_global_farm | XYKLiquidityMiningCall_update_yield_farm | XYKLiquidityMiningCall_withdraw_shares
 ...
 */
export interface XYKLiquidityMiningCall_add_liquidity_and_join_farms {
    __kind: 'add_liquidity_and_join_farms'
    assetA: number
    assetB: number
    amountA: bigint
...
export const StableswapCall: sts.Type<StableswapCall> = sts.closedEnum(() => {
    return  {
        ...
        remove_liquidity: sts.enumStruct({
            poolId: sts.number(),
            shareAmount: sts.bigint(),
            minAmountsOut: sts.array(() => AssetAmount),
        }),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const SignetCall: sts.Type<SignetCall> = sts.closedEnum(() => {
    return  {
        initialize: sts.enumStruct({
            admin: AccountId32,
            signatureDeposit: sts.bigint(),
            chainId: sts.bytes(),
        }),
        respond: sts.enumStruct({
            requestIds: sts.array(() => sts.bytes()),
            signatures: sts.array(() => Signature),
        }),
        respond_bidirectional: sts.enumStruct({
            requestId: sts.bytes(),
            serializedOutput: sts.bytes(),
            signature: Signature,
        }),
        respond_error: sts.enumStruct({
            errors: sts.array(() => ErrorResponse),
        }),
        sign: sts.enumStruct({
            payload: sts.bytes(),
            keyVersion: sts.number(),
            path: sts.bytes(),
            algo: sts.bytes(),
            dest: sts.bytes(),
            params: sts.bytes(),
        }),
        sign_bidirectional: sts.enumStruct({
            serializedTransaction: sts.bytes(),
            caip2Id: sts.bytes(),
            keyVersion: sts.number(),
            path: sts.bytes(),
            algo: sts.bytes(),
            dest: sts.bytes(),
            params: sts.bytes(),
            outputDeserializationSchema: sts.bytes(),
            respondSerializationSchema: sts.bytes(),
        }),
        update_deposit: sts.enumStruct({
            newDeposit: sts.bigint(),
        }),
        withdraw_funds: sts.enumStruct({
...
export const ErrorResponse: sts.Type<ErrorResponse> = sts.struct(() => {
    return  {
        requestId: sts.bytes(),
        errorMessage: sts.bytes(),
    }
})
...
export const Signature: sts.Type<Signature> = sts.struct(() => {
    return  {
        bigR: AffinePoint,
        s: sts.bytes(),
        recoveryId: sts.number(),
    }
})

export const AffinePoint: sts.Type<AffinePoint> = sts.struct(() => {
    return  {
        x: sts.bytes(),
        y: sts.bytes(),
    }
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type SignetCall = SignetCall_initialize | SignetCall_respond | SignetCall_respond_bidirectional | SignetCall_respond_error | SignetCall_sign | SignetCall_sign_bidirectional | SignetCall_update_deposit | SignetCall_withdraw_funds

/**
 * Initialize the pallet with admin, deposit, and chain ID
 */
export interface SignetCall_initialize {
    __kind: 'initialize'
    admin: AccountId32
 ...
 */
export interface SignetCall_respond {
    __kind: 'respond'
    requestIds: Bytes[]
 ...
 */
export interface SignetCall_respond_bidirectional {
    __kind: 'respond_bidirectional'
    requestId: Bytes
 ...
 */
export interface SignetCall_respond_error {
    __kind: 'respond_error'
 ...
 */
export interface SignetCall_sign {
    __kind: 'sign'
    payload: Bytes
    keyVersion: number
    path: Bytes
 ...
 */
export interface SignetCall_sign_bidirectional {
    __kind: 'sign_bidirectional'
 ...
 */
export interface SignetCall_update_deposit {
 ...
 */
export interface SignetCall_withdraw_funds {
...
export const Type_431: sts.Type<Type_431> = sts.closedEnum(() => {
    return  {
        V3: sts.array(() => Type_434),
        V4: sts.array(() => Type_438),
        V5: sts.array(() => Type_441),
    }
})
...
export const Type_435: sts.Type<Type_435> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})

export interface Type_435 {
    encoded: Bytes
}

export type Type_441 = Type_441_AliasOrigin | Type_441_BurnAsset | Type_441_BuyExecution | Type_441_ClaimAsset | Type_441_ClearError | Type_441_ClearOrigin | Type_441_ClearTopic | Type_441_ClearTransactStatus | Type_441_DepositAsset | Type_441_DepositReserveAsset | Type_441_DescendOrigin | Type_441_ExchangeAsset | Type_441_ExecuteWithOrigin | Type_441_ExpectAsset | Type_441_ExpectError | Type_441_ExpectOrigin | Type_441_ExpectPallet | Type_441_ExpectTransactStatus | Type_441_ExportMessage | Type_441_HrmpChannelAccepted | Type_441_HrmpChannelClosing | Type_441_HrmpNewChannelOpenRequest | Type_441_InitiateReserveWithdraw | Type_441_InitiateTeleport | Type_441_InitiateTransfer | Type_441_LockAsset | Type_441_NoteUnlockable | Type_441_PayFees | Type_441_QueryPallet | Type_441_QueryResponse | Type_441_ReceiveTeleportedAsset | Type_441_RefundSurplus | Type_441_ReportError | Type_441_ReportHolding | Type_441_ReportTransactStatus | Type_441_RequestUnlock | Type_441_ReserveAssetDeposited | Type_441_SetAppendix | Type_441_SetErrorHandler | Type_441_SetFeesMode | Type_441_SetHints | Type_441_SetTopic | Type_441_SubscribeVersion | Type_441_Transact | Type_441_TransferAsset | Type_441_TransferReserveAsset | Type_441_Trap | Type_441_UniversalOrigin | Type_441_UnlockAsset | Type_441_UnpaidExecution | Type_441_UnsubscribeVersion | Type_441_WithdrawAsset

export interface Type_441_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V5Location
}

export interface Type_441_BurnAsset {
    __kind: 'BurnAsset'
    value: V5Asset[]
}
...
export interface Type_441_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_441_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_441_ExecuteWithOrigin {
    __kind: 'ExecuteWithOrigin'
    descendantOrigin?: (V5Junctions | undefined)
    xcm: Type_441[]
}

export interface Type_441_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V5Asset[]
}

export interface Type_441_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V5Error] | undefined)
}

export interface Type_441_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V5Location | undefined)
}

export interface Type_441_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_441_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_441_ExportMessage {
    __kind: 'ExportMessage'
    network: V5NetworkId
    destination: V5Junctions
    xcm: V5Instruction[]
...
export interface Type_441_InitiateTransfer {
    __kind: 'InitiateTransfer'
    destination: V5Location
    remoteFees?: (V5AssetTransferFilter | undefined)
    preserveOrigin: boolean
...
export interface Type_441_LockAsset {
    __kind: 'LockAsset'
    asset: V5Asset
    unlocker: V5Location
}

export interface Type_441_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V5Asset
    owner: V5Location
}

export interface Type_441_PayFees {
    __kind: 'PayFees'
    asset: V5Asset
}

export interface Type_441_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V5QueryResponseInfo
}
...
export interface Type_441_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V5QueryResponseInfo
    assets: V5AssetFilter
}

export interface Type_441_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V5QueryResponseInfo
}

export interface Type_441_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V5Asset
    locker: V5Location
}
...
export interface Type_441_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_441_SetHints {
    __kind: 'SetHints'
    hints: V5Hint[]
}

export interface Type_441_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_441_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V5Junction
}

export interface Type_441_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V5Asset
    target: V5Location
}

export interface Type_441_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V5Location | undefined)
}
...
export type Type_438 = Type_438_AliasOrigin | Type_438_BurnAsset | Type_438_BuyExecution | Type_438_ClaimAsset | Type_438_ClearError | Type_438_ClearOrigin | Type_438_ClearTopic | Type_438_ClearTransactStatus | Type_438_DepositAsset | Type_438_DepositReserveAsset | Type_438_DescendOrigin | Type_438_ExchangeAsset | Type_438_ExpectAsset | Type_438_ExpectError | Type_438_ExpectOrigin | Type_438_ExpectPallet | Type_438_ExpectTransactStatus | Type_438_ExportMessage | Type_438_HrmpChannelAccepted | Type_438_HrmpChannelClosing | Type_438_HrmpNewChannelOpenRequest | Type_438_InitiateReserveWithdraw | Type_438_InitiateTeleport | Type_438_LockAsset | Type_438_NoteUnlockable | Type_438_QueryPallet | Type_438_QueryResponse | Type_438_ReceiveTeleportedAsset | Type_438_RefundSurplus | Type_438_ReportError | Type_438_ReportHolding | Type_438_ReportTransactStatus | Type_438_RequestUnlock | Type_438_ReserveAssetDeposited | Type_438_SetAppendix | Type_438_SetErrorHandler | Type_438_SetFeesMode | Type_438_SetTopic | Type_438_SubscribeVersion | Type_438_Transact | Type_438_TransferAsset | Type_438_TransferReserveAsset | Type_438_Trap | Type_438_UniversalOrigin | Type_438_UnlockAsset | Type_438_UnpaidExecution | Type_438_UnsubscribeVersion | Type_438_WithdrawAsset

export interface Type_438_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V4Location
}

export interface Type_438_BurnAsset {
    __kind: 'BurnAsset'
    value: V4Asset[]
}
...
export interface Type_438_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_438_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_438_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V4Asset[]
}

export interface Type_438_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_438_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V4Location | undefined)
}

export interface Type_438_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_438_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_438_ExportMessage {
    __kind: 'ExportMessage'
    network: V4NetworkId
    destination: V4Junctions
    xcm: V4Instruction[]
...
export interface Type_438_LockAsset {
    __kind: 'LockAsset'
    asset: V4Asset
    unlocker: V4Location
}

export interface Type_438_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V4Asset
    owner: V4Location
}

export interface Type_438_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V4QueryResponseInfo
}
...
export interface Type_438_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V4QueryResponseInfo
    assets: V4AssetFilter
}

export interface Type_438_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V4QueryResponseInfo
}

export interface Type_438_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V4Asset
    locker: V4Location
}
...
export interface Type_438_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_438_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_438_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V4Junction
}

export interface Type_438_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V4Asset
    target: V4Location
}

export interface Type_438_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V4Location | undefined)
}
...
export type Type_431 = Type_431_V3 | Type_431_V4 | Type_431_V5

export interface Type_431_V3 {
    __kind: 'V3'
    value: Type_434[]
}

export interface Type_431_V4 {
    __kind: 'V4'
    value: Type_438[]
}

export interface Type_431_V5 {
    __kind: 'V5'
    value: Type_441[]
}
...
export const OmnipoolLiquidityMiningCall: sts.Type<OmnipoolLiquidityMiningCall> = sts.closedEnum(() => {
    return  {
        ...
        remove_liquidity_stableswap_omnipool_and_exit_farms: sts.enumStruct({
            positionId: sts.bigint(),
            omnipoolMinLimit: sts.bigint(),
            stableswapMinAmountsOut: sts.array(() => AssetAmount),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type OmnipoolLiquidityMiningCall = OmnipoolLiquidityMiningCall_add_liquidity_and_join_farms | OmnipoolLiquidityMiningCall_add_liquidity_stableswap_omnipool_and_join_farms | OmnipoolLiquidityMiningCall_claim_rewards | OmnipoolLiquidityMiningCall_create_global_farm | OmnipoolLiquidityMiningCall_create_yield_farm | OmnipoolLiquidityMiningCall_deposit_shares | OmnipoolLiquidityMiningCall_exit_farms | OmnipoolLiquidityMiningCall_join_farms | OmnipoolLiquidityMiningCall_redeposit_shares | OmnipoolLiquidityMiningCall_remove_liquidity_stableswap_omnipool_and_exit_farms | OmnipoolLiquidityMiningCall_resume_yield_farm | OmnipoolLiquidityMiningCall_stop_yield_farm | OmnipoolLiquidityMiningCall_terminate_global_farm | OmnipoolLiquidityMiningCall_terminate_yield_farm | OmnipoolLiquidityMiningCall_update_global_farm | OmnipoolLiquidityMiningCall_update_yield_farm | OmnipoolLiquidityMiningCall_withdraw_shares
 ...
 * Emits `SharesRedeposited` event for each farm entry after the first one
 */
export interface OmnipoolLiquidityMiningCall_add_liquidity_and_join_farms {
    __kind: 'add_liquidity_and_join_farms'
    farmEntries: [number, number][]
    asset: number
    amount: bigint
 ...
 * 
 */
export interface OmnipoolLiquidityMiningCall_exit_farms {
    __kind: 'exit_farms'
    depositId: bigint
    yieldFarmIds: number[]
}
 ...
 * Emits `SharesRedeposited` event for each farm entry after the first one
 */
export interface OmnipoolLiquidityMiningCall_join_farms {
    __kind: 'join_farms'
    farmEntries: [number, number][]
    positionId: bigint
}
 ...
 * 
 */
export interface OmnipoolLiquidityMiningCall_remove_liquidity_stableswap_omnipool_and_exit_farms {
    __kind: 'remove_liquidity_stableswap_omnipool_and_exit_farms'
    positionId: bigint
    omnipoolMinLimit: bigint
    stableswapMinAmountsOut: AssetAmount[]
...
export const OmnipoolCall: sts.Type<OmnipoolCall> = sts.closedEnum(() => {
    return  {
        add_all_liquidity: sts.enumStruct({
            asset: sts.number(),
        ...
        remove_all_liquidity: sts.enumStruct({
            positionId: sts.bigint(),
            minLimit: sts.bigint(),
        }),
        remove_liquidity: sts.enumStruct({
        ...
        set_slip_fee: sts.enumStruct({
            slipFee: sts.option(() => SlipFeeConfig),
        }),
...
export const SlipFeeConfig: sts.Type<SlipFeeConfig> = sts.struct(() => {
    return  {
        maxSlipFee: Permill,
    }
})

export interface SlipFeeConfig {
    maxSlipFee: Permill
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type OmnipoolCall = OmnipoolCall_add_all_liquidity | OmnipoolCall_add_liquidity | OmnipoolCall_add_liquidity_with_limit | OmnipoolCall_add_token | OmnipoolCall_buy | OmnipoolCall_refund_refused_asset | OmnipoolCall_remove_all_liquidity | OmnipoolCall_remove_liquidity | OmnipoolCall_remove_liquidity_with_limit | OmnipoolCall_remove_token | OmnipoolCall_sacrifice_position | OmnipoolCall_sell | OmnipoolCall_set_asset_tradable_state | OmnipoolCall_set_asset_weight_cap | OmnipoolCall_set_slip_fee | OmnipoolCall_withdraw_protocol_liquidity
 ...
 * 
 */
export interface OmnipoolCall_add_all_liquidity {
    __kind: 'add_all_liquidity'
    asset: number
 ...
 * 
 */
export interface OmnipoolCall_remove_all_liquidity {
    __kind: 'remove_all_liquidity'
    positionId: bigint
    minLimit: bigint
}
 ...
 */
export interface OmnipoolCall_set_slip_fee {
    __kind: 'set_slip_fee'
    slipFee?: (SlipFeeConfig | undefined)
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const MultiBlockMigrationsCall: sts.Type<MultiBlockMigrationsCall> = sts.closedEnum(() => {
    return  {
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type MultiBlockMigrationsCall = MultiBlockMigrationsCall_clear_historic | MultiBlockMigrationsCall_force_onboard_mbms | MultiBlockMigrationsCall_force_set_active_cursor | MultiBlockMigrationsCall_force_set_cursor
 ...
 */
export interface MultiBlockMigrationsCall_clear_historic {
 ...
 */
export interface MultiBlockMigrationsCall_force_onboard_mbms {
 ...
 */
export interface MultiBlockMigrationsCall_force_set_active_cursor {
 ...
 */
export interface MultiBlockMigrationsCall_force_set_cursor {
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const LiquidationCall: sts.Type<LiquidationCall> = sts.closedEnum(() => {
    return  {
        liquidate: sts.enumStruct({
        ...
        set_borrowing_contract: sts.enumStruct({
            contract: H160,
        }),
    }
})
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type LiquidationCall = LiquidationCall_liquidate | LiquidationCall_set_borrowing_contract
 ...
 * 
 */
export interface LiquidationCall_liquidate {
    __kind: 'liquidate'
 ...
 */
export interface LiquidationCall_set_borrowing_contract {
    __kind: 'set_borrowing_contract'
    contract: H160
}
...
export const HSMCall: sts.Type<HSMCall> = sts.closedEnum(() => {
    return  {
        ...
        execute_arbitrage: sts.enumStruct({
            ...
            arbitrage: sts.option(() => Arbitrage),
        }),
...
export const Arbitrage: sts.Type<Arbitrage> = sts.closedEnum(() => {
    return  {
        HollarIn: sts.bigint(),
        HollarOut: sts.bigint(),
    }
})

export type Arbitrage = Arbitrage_HollarIn | Arbitrage_HollarOut

export interface Arbitrage_HollarIn {
    __kind: 'HollarIn'
    value: bigint
}

export interface Arbitrage_HollarOut {
    __kind: 'HollarOut'
    value: bigint
}
 ...
 */
export const EthDispenserCall: sts.Type<EthDispenserCall> = sts.closedEnum(() => {
    return  {
        pause: sts.unit(),
        request_fund: sts.enumStruct({
            to: H160,
            amount: sts.bigint(),
            requestId: sts.bytes(),
            tx: EvmTransactionParams,
        }),
        set_faucet_balance: sts.enumStruct({
            balanceWei: sts.bigint(),
        }),
        unpause: sts.unit(),
    }
})

export const EvmTransactionParams: sts.Type<EvmTransactionParams> = sts.struct(() => {
    return  {
        value: sts.bigint(),
        gasLimit: sts.bigint(),
        maxFeePerGas: sts.bigint(),
 ...
 * Dispatchable functions.
 */
export type EthDispenserCall = EthDispenserCall_pause | EthDispenserCall_request_fund | EthDispenserCall_set_faucet_balance | EthDispenserCall_unpause
 ...
 */
export interface EthDispenserCall_pause {
    __kind: 'pause'
}
 ...
 */
export interface EthDispenserCall_request_fund {
    __kind: 'request_fund'
    to: H160
    amount: bigint
    requestId: Bytes
 ...
 */
export interface EthDispenserCall_set_faucet_balance {
    __kind: 'set_faucet_balance'
    balanceWei: bigint
}
 ...
 * - `origin`: Must satisfy `UpdateOrigin`
 */
export interface EthDispenserCall_unpause {
    __kind: 'unpause'
}
...
export const EmaOracleCall: sts.Type<EmaOracleCall> = sts.closedEnum(() => {
    return  {
        add_authorized_account: sts.enumStruct({
            source: sts.bytes(),
        ...
        register_external_source: sts.enumStruct({
            source: sts.bytes(),
        }),
        remove_authorized_account: sts.enumStruct({
            source: sts.bytes(),
            assets: sts.tuple(() => [sts.number(), sts.number()]),
            account: AccountId32,
        }),
        remove_external_source: sts.enumStruct({
            source: sts.bytes(),
        }),
        ...
        set_external_oracle: sts.enumStruct({
            source: sts.bytes(),
            assetA: VersionedLocation,
            assetB: VersionedLocation,
            price: sts.tuple(() => [sts.bigint(), sts.bigint()]),
        }),
        set_external_oracle_by_ids: sts.enumStruct({
            source: sts.bytes(),
            assetA: sts.number(),
            assetB: sts.number(),
            price: sts.tuple(() => [sts.bigint(), sts.bigint()]),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type EmaOracleCall = EmaOracleCall_add_authorized_account | EmaOracleCall_add_oracle | EmaOracleCall_register_external_source | EmaOracleCall_remove_authorized_account | EmaOracleCall_remove_external_source | EmaOracleCall_remove_oracle | EmaOracleCall_set_external_oracle | EmaOracleCall_set_external_oracle_by_ids | EmaOracleCall_update_bifrost_oracle
 ...
 */
export interface EmaOracleCall_add_authorized_account {
    __kind: 'add_authorized_account'
    source: Bytes
 ...
 */
export interface EmaOracleCall_register_external_source {
    __kind: 'register_external_source'
    source: Bytes
}
 ...
 */
export interface EmaOracleCall_remove_authorized_account {
    __kind: 'remove_authorized_account'
    source: Bytes
    assets: [number, number]
    account: AccountId32
}
 ...
 */
export interface EmaOracleCall_remove_external_source {
    __kind: 'remove_external_source'
    source: Bytes
}
 ...
 */
export interface EmaOracleCall_set_external_oracle {
    __kind: 'set_external_oracle'
    source: Bytes
    assetA: VersionedLocation
    assetB: VersionedLocation
    price: [bigint, bigint]
 ...
 * Emits `OracleUpdated` event on the next `on_finalize`.
 */
export interface EmaOracleCall_set_external_oracle_by_ids {
    __kind: 'set_external_oracle_by_ids'
    source: Bytes
    assetA: number
    assetB: number
    price: [bigint, bigint]
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type EVMAccountsCall = EVMAccountsCall_add_contract_deployer | EVMAccountsCall_approve_contract | EVMAccountsCall_bind_evm_address | EVMAccountsCall_claim_account | EVMAccountsCall_disapprove_contract | EVMAccountsCall_remove_contract_deployer | EVMAccountsCall_renounce_contract_deployer
...
export const DynamicFeesCall: sts.Type<DynamicFeesCall> = sts.closedEnum(() => {
    return  {
        remove_asset_fee: sts.enumStruct({
            assetId: sts.number(),
        }),
        set_asset_fee: sts.enumStruct({
            assetId: sts.number(),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type DynamicFeesCall = DynamicFeesCall_remove_asset_fee | DynamicFeesCall_set_asset_fee
 ...
 */
export interface DynamicFeesCall_set_asset_fee {
    __kind: 'set_asset_fee'
    assetId: number
    config: AssetFeeConfig
}
...
export const DusterCall: sts.Type<DusterCall> = sts.closedEnum(() => {
    return  {
        ...
        whitelist_account: sts.enumStruct({
            account: AccountId32,
        }),
    }
})
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type DusterCall = DusterCall_dust_account | DusterCall_remove_from_whitelist | DusterCall_whitelist_account
 ...
 * 
 */
export interface DusterCall_remove_from_whitelist {
 ...
 * 
 */
export interface DusterCall_whitelist_account {
    __kind: 'whitelist_account'
    account: AccountId32
}
...
export const DispatcherCall: sts.Type<DispatcherCall> = sts.closedEnum(() => {
    return  {
        ...
        dispatch_as_emergency_admin: sts.enumStruct({
            call: Call,
        }),
        ...
        dispatch_with_fee_payer: sts.enumStruct({
            call: Call,
        }),
        note_aave_manager: sts.enumStruct({
            account: AccountId32,
        }),
        pause_hyperbridge_cleanup: sts.enumStruct({
            doPause: sts.boolean(),
        }),
    }
})
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type DispatcherCall = DispatcherCall_dispatch_as_aave_manager | DispatcherCall_dispatch_as_emergency_admin | DispatcherCall_dispatch_as_treasury | DispatcherCall_dispatch_evm_call | DispatcherCall_dispatch_with_extra_gas | DispatcherCall_dispatch_with_fee_payer | DispatcherCall_note_aave_manager | DispatcherCall_pause_hyperbridge_cleanup
 ...
 */
export interface DispatcherCall_dispatch_as_emergency_admin {
    __kind: 'dispatch_as_emergency_admin'
    call: Call
}
...
export interface DispatcherCall_dispatch_with_fee_payer {
    __kind: 'dispatch_with_fee_payer'
    call: Call
}
 ...
 */
export interface DispatcherCall_pause_hyperbridge_cleanup {
    __kind: 'pause_hyperbridge_cleanup'
    doPause: boolean
}
...
export const DCACall: sts.Type<DCACall> = sts.closedEnum(() => {
    return  {
        ...
        unlock_reserves: sts.enumStruct({
            who: AccountId32,
            assetId: sts.number(),
        }),
    }
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type DCACall = DCACall_schedule | DCACall_terminate | DCACall_unlock_reserves
 ...
 * 
 */
export interface DCACall_unlock_reserves {
    __kind: 'unlock_reserves'
    who: AccountId32
    assetId: number
}
...
export type Type_66 = Type_66_Split | Type_66_SplitAbstain | Type_66_Standard

export interface Type_66_Split {
    __kind: 'Split'
    aye: bigint
    nay: bigint
}

export interface Type_66_SplitAbstain {
    __kind: 'SplitAbstain'
    aye: bigint
    nay: bigint
    abstain: bigint
...
export interface Type_66_Standard {
    __kind: 'Standard'
    vote: number
    balance: bigint
}
...
export type Type_177 = Type_177_Locked1x | Type_177_Locked2x | Type_177_Locked3x | Type_177_Locked4x | Type_177_Locked5x | Type_177_Locked6x | Type_177_None

export interface Type_177_Locked1x {
    __kind: 'Locked1x'
}

export interface Type_177_Locked2x {
    __kind: 'Locked2x'
}

export interface Type_177_Locked3x {
    __kind: 'Locked3x'
}

export interface Type_177_Locked4x {
    __kind: 'Locked4x'
}

export interface Type_177_Locked5x {
    __kind: 'Locked5x'
}

export interface Type_177_Locked6x {
    __kind: 'Locked6x'
}

export interface Type_177_None {
    __kind: 'None'
}
...
export const CircuitBreakerCall: sts.Type<CircuitBreakerCall> = sts.closedEnum(() => {
    return  {
        add_egress_accounts: sts.enumStruct({
            accounts: sts.array(() => AccountId32),
        }),
        force_lift_lockdown: sts.enumStruct({
            assetId: sts.number(),
        }),
        lockdown_asset: sts.enumStruct({
            assetId: sts.number(),
            until: sts.number(),
        }),
        ...
        remove_egress_accounts: sts.enumStruct({
            accounts: sts.array(() => AccountId32),
        }),
        reset_withdraw_lockdown: sts.unit(),
        set_add_liquidity_limit: sts.enumStruct({
            assetId: sts.number(),
            liquidityLimit: sts.option(() => sts.tuple(() => [sts.number(), sts.number()])),
        }),
        set_asset_category: sts.enumStruct({
            assetId: sts.number(),
            category: sts.option(() => GlobalAssetCategory),
        }),
        set_global_withdraw_limit_params: sts.enumStruct({
            parameters: GlobalWithdrawLimitParameters,
        }),
        set_global_withdraw_lockdown: sts.enumStruct({
            until: sts.bigint(),
        }),
...
export const GlobalWithdrawLimitParameters: sts.Type<GlobalWithdrawLimitParameters> = sts.struct(() => {
    return  {
        limit: sts.bigint(),
        window: sts.bigint(),
    }
...
export interface GlobalWithdrawLimitParameters {
    limit: bigint
    window: bigint
}

export const GlobalAssetCategory: sts.Type<GlobalAssetCategory> = sts.closedEnum(() => {
    return  {
        External: sts.unit(),
        Local: sts.unit(),
    }
...
export type GlobalAssetCategory = GlobalAssetCategory_External | GlobalAssetCategory_Local

export interface GlobalAssetCategory_External {
    __kind: 'External'
}

export interface GlobalAssetCategory_Local {
    __kind: 'Local'
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type CircuitBreakerCall = CircuitBreakerCall_add_egress_accounts | CircuitBreakerCall_force_lift_lockdown | CircuitBreakerCall_lockdown_asset | CircuitBreakerCall_release_deposit | CircuitBreakerCall_remove_egress_accounts | CircuitBreakerCall_reset_withdraw_lockdown | CircuitBreakerCall_set_add_liquidity_limit | CircuitBreakerCall_set_asset_category | CircuitBreakerCall_set_global_withdraw_limit_params | CircuitBreakerCall_set_global_withdraw_lockdown | CircuitBreakerCall_set_remove_liquidity_limit | CircuitBreakerCall_set_trade_volume_limit

export interface CircuitBreakerCall_add_egress_accounts {
    __kind: 'add_egress_accounts'
 ...
 */
export interface CircuitBreakerCall_force_lift_lockdown {
    __kind: 'force_lift_lockdown'
    assetId: number
}
 ...
 */
export interface CircuitBreakerCall_lockdown_asset {
    __kind: 'lockdown_asset'
    assetId: number
    until: number
}
 ...
 */
export interface CircuitBreakerCall_release_deposit {
    __kind: 'release_deposit'
    who: AccountId32
    assetId: number
}

export interface CircuitBreakerCall_remove_egress_accounts {
    __kind: 'remove_egress_accounts'
    accounts: AccountId32[]
}
 ...
 */
export interface CircuitBreakerCall_reset_withdraw_lockdown {
    __kind: 'reset_withdraw_lockdown'
}
...
export interface CircuitBreakerCall_set_asset_category {
    __kind: 'set_asset_category'
    assetId: number
    category?: (GlobalAssetCategory | undefined)
}
 ...
 * Can be called only by authority origin.
 */
export interface CircuitBreakerCall_set_global_withdraw_limit_params {
    __kind: 'set_global_withdraw_limit_params'
    parameters: GlobalWithdrawLimitParameters
}

export interface CircuitBreakerCall_set_global_withdraw_lockdown {
    __kind: 'set_global_withdraw_lockdown'
    until: bigint
}
...
export interface Call_EthDispenser {
    __kind: 'EthDispenser'
    value: EthDispenserCall
}
...
export interface Call_Liquidation {
    __kind: 'Liquidation'
...
export interface Call_MultiBlockMigrations {
    __kind: 'MultiBlockMigrations'
    value: MultiBlockMigrationsCall
}
