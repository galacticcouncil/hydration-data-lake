...
export const Type_147: sts.Type<Type_147> = sts.struct(() => {
    return  {
...
export interface Type_404 {
    id: Bytes
    amount: bigint
}

export const Type_404: sts.Type<Type_404> = sts.struct(() => {
    return  {
        id: sts.bytes(),
        amount: sts.bigint(),
    }
 ...
 */
export type OmnipoolEvent = OmnipoolEvent_AssetRefunded | OmnipoolEvent_AssetWeightCapUpdated | OmnipoolEvent_BuyExecuted | OmnipoolEvent_LiquidityAdded | OmnipoolEvent_LiquidityRemoved | OmnipoolEvent_PositionCreated | OmnipoolEvent_PositionDestroyed | OmnipoolEvent_PositionUpdated | OmnipoolEvent_SellExecuted | OmnipoolEvent_TokenAdded | OmnipoolEvent_TradableStateUpdated
