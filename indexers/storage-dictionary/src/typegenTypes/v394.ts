...
export type Type_572 = Type_572_ProposalSubmission

export interface Type_572_ProposalSubmission {
    __kind: 'ProposalSubmission'
}

export type Type_573 = Type_573_SlashForMigrate

export interface Type_573_SlashForMigrate {
...
export type Type_574 = Type_574_AuthorizeAlias

export interface Type_574_AuthorizeAlias {
...
export const RuntimeHoldReason: sts.Type<RuntimeHoldReason> = sts.closedEnum(() => {
    return  {
        PolkadotXcm: Type_574,
        Preimage: HoldReason,
        StateTrieMigration: Type_573,
        TechnicalCommittee: Type_572,
    }
})

export const Type_572: sts.Type<Type_572> = sts.closedEnum(() => {
    return  {
        ProposalSubmission: sts.unit(),
    }
})

export const Type_573: sts.Type<Type_573> = sts.closedEnum(() => {
    return  {
...
export const Type_574: sts.Type<Type_574> = sts.closedEnum(() => {
    return  {
