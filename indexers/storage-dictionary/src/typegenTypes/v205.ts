...
export const V5UpgradeGoAhead: sts.Type<V5UpgradeGoAhead> = sts.closedEnum(() => {
    return  {
        Abort: sts.unit(),
        GoAhead: sts.unit(),
    }
...
export const SegmentTracker: sts.Type<SegmentTracker> = sts.struct(() => {
    return  {
        ...
        consumedGoAheadSignal: sts.option(() => V5UpgradeGoAhead),
    }
})
...
export const V5AbridgedHostConfiguration: sts.Type<V5AbridgedHostConfiguration> = sts.struct(() => {
    return  {
...
export interface MessagingStateSnapshot {
    ...
    ingressChannels: [Id, V5AbridgedHrmpChannel][]
    egressChannels: [Id, V5AbridgedHrmpChannel][]
}
...
export const MessagingStateSnapshot: sts.Type<MessagingStateSnapshot> = sts.struct(() => {
    return  {
        dmqMqcHead: H256,
        relayDispatchQueueRemainingCapacity: RelayDispatchQueueRemainingCapacity,
        ingressChannels: sts.array(() => sts.tuple(() => [Id, V5AbridgedHrmpChannel])),
        egressChannels: sts.array(() => sts.tuple(() => [Id, V5AbridgedHrmpChannel])),
    }
})

export const V5AbridgedHrmpChannel: sts.Type<V5AbridgedHrmpChannel> = sts.struct(() => {
    return  {
...
export type Event = Event_AssetRegistry | Event_Balances | Event_Bonds | Event_CircuitBreaker | Event_Claims | Event_CollatorRewards | Event_CollatorSelection | Event_Council | Event_CumulusXcm | Event_Currencies | Event_DCA | Event_Democracy | Event_DmpQueue | Event_Duster | Event_DynamicFees | Event_EVM | Event_Elections | Event_EmaOracle | Event_Ethereum | Event_Identity | Event_LBP | Event_MultiTransactionPayment | Event_Multisig | Event_OTC | Event_Omnipool | Event_OmnipoolLiquidityMining | Event_OmnipoolWarehouseLM | Event_OrmlXcm | Event_ParachainSystem | Event_PolkadotXcm | Event_Preimage | Event_Proxy | Event_Referrals | Event_RelayChainInfo | Event_Router | Event_Scheduler | Event_Session | Event_Stableswap | Event_Staking | Event_System | Event_TechnicalCommittee | Event_Tips | Event_Tokens | Event_TransactionPause | Event_TransactionPayment | Event_Treasury | Event_Uniques | Event_UnknownTokens | Event_Utility | Event_Vesting | Event_XTokens | Event_XYK | Event_XcmRateLimiter | Event_XcmpQueue
...
export interface Event_XcmRateLimiter {
    __kind: 'XcmRateLimiter'
    value: XcmRateLimiterEvent
}
 ...
 */
export type XcmpQueueEvent = XcmpQueueEvent_BadFormat | XcmpQueueEvent_BadVersion | XcmpQueueEvent_DeferredBucketDiscarded | XcmpQueueEvent_DeferredXcmDiscarded | XcmpQueueEvent_Fail | XcmpQueueEvent_OverweightEnqueued | XcmpQueueEvent_OverweightServiced | XcmpQueueEvent_Success | XcmpQueueEvent_XcmDeferred | XcmpQueueEvent_XcmDeferredQueueFull | XcmpQueueEvent_XcmpMessageSent
 ...
 */
export interface XcmpQueueEvent_DeferredBucketDiscarded {
    __kind: 'DeferredBucketDiscarded'
    sender: Id
    index: [number, number]
}
 ...
 */
export interface XcmpQueueEvent_DeferredXcmDiscarded {
    __kind: 'DeferredXcmDiscarded'
    sender: Id
    sentAt: number
    deferredTo: number
    index: [number, number]
 ...
 * The `Event` enum of this pallet
 */
export type XcmRateLimiterEvent = never
 ...
 * The `Event` enum of this pallet
 */
export type RouterEvent = RouterEvent_RouteExecuted | RouterEvent_RouteUpdated
 ...
 * The `Event` enum of this pallet
 */
export type CollatorSelectionEvent = CollatorSelectionEvent_CandidateAdded | CollatorSelectionEvent_CandidateRemoved | CollatorSelectionEvent_InvalidInvulnerableSkipped | CollatorSelectionEvent_InvulnerableAdded | CollatorSelectionEvent_InvulnerableRemoved | CollatorSelectionEvent_NewCandidacyBond | CollatorSelectionEvent_NewDesiredCandidates | CollatorSelectionEvent_NewInvulnerables
...
export const Event: sts.Type<Event> = sts.closedEnum(() => {
    return  {
        ...
        XYK: XYKEvent,
        XcmRateLimiter: XcmRateLimiterEvent,
...
export const XcmpQueueEvent: sts.Type<XcmpQueueEvent> = sts.closedEnum(() => {
    return  {
        ...
        DeferredBucketDiscarded: sts.enumStruct({
            sender: Id,
            index: sts.tuple(() => [sts.number(), sts.number()]),
        }),
        DeferredXcmDiscarded: sts.enumStruct({
            sender: Id,
            sentAt: sts.number(),
        ...
        XcmDeferredQueueFull: sts.enumStruct({
            sender: Id,
            sentAt: sts.number(),
            messageHash: sts.option(() => sts.bytes()),
        }),
 ...
 * The `Event` enum of this pallet
 */
export const XcmRateLimiterEvent: sts.Type<XcmRateLimiterEvent> = sts.closedEnum(() => {
    return  {
    }
})
