 ...
 * The `Event` enum of this pallet
 */
export type StableswapEvent = StableswapEvent_AmplificationChanging | StableswapEvent_BuyExecuted | StableswapEvent_FeeUpdated | StableswapEvent_LiquidityAdded | StableswapEvent_LiquidityRemoved | StableswapEvent_PoolCreated | StableswapEvent_PoolDestroyed | StableswapEvent_PoolMaxPegUpdateUpdated | StableswapEvent_PoolPegSourceUpdated | StableswapEvent_SellExecuted | StableswapEvent_TradableStateUpdated
 ...
 */
export interface StableswapEvent_PoolMaxPegUpdateUpdated {
    __kind: 'PoolMaxPegUpdateUpdated'
    poolId: number
 ...
 */
export interface StableswapEvent_PoolPegSourceUpdated {
    __kind: 'PoolPegSourceUpdated'
    poolId: number
    assetId: number
    pegSource: PegSource
}
 ...
 * The `Event` enum of this pallet
 */
export type HSMEvent = HSMEvent_ArbitrageExecuted | HSMEvent_CollateralAdded | HSMEvent_CollateralRemoved | HSMEvent_CollateralUpdated | HSMEvent_FlashMinterSet
 ...
 */
export interface HSMEvent_ArbitrageExecuted {
    __kind: 'ArbitrageExecuted'
    assetId: number
    hollarAmount: bigint
}
 ...
 */
export interface HSMEvent_CollateralAdded {
    __kind: 'CollateralAdded'
    assetId: number
    poolId: number
    purchaseFee: Permill
 ...
 */
export interface HSMEvent_CollateralRemoved {
    __kind: 'CollateralRemoved'
    assetId: number
    amount: bigint
}
 ...
 */
export interface HSMEvent_CollateralUpdated {
    __kind: 'CollateralUpdated'
    assetId: number
 ...
 */
export interface HSMEvent_FlashMinterSet {
    __kind: 'FlashMinterSet'
    flashMinter: H160
}
 ...
 * The `Event` enum of this pallet
 */
export type BroadcastEvent = BroadcastEvent_Swapped3
 ...
 * 
 */
export interface BroadcastEvent_Swapped3 {
    __kind: 'Swapped3'
    swapper: AccountId32
    filler: AccountId32
    fillerType: Filler
...
export const StableswapEvent: sts.Type<StableswapEvent> = sts.closedEnum(() => {
    return  {
        ...
        PoolCreated: sts.enumStruct({
            ...
            amplification: NonZeroU16,
            fee: Permill,
            peg: sts.option(() => PoolPegInfo),
        }),
        PoolDestroyed: sts.enumStruct({
            poolId: sts.number(),
        }),
        PoolMaxPegUpdateUpdated: sts.enumStruct({
            poolId: sts.number(),
            maxPegUpdate: Permill,
        }),
        PoolPegSourceUpdated: sts.enumStruct({
            poolId: sts.number(),
            assetId: sts.number(),
            pegSource: PegSource,
        }),
 ...
 * The `Event` enum of this pallet
 */
export const HSMEvent: sts.Type<HSMEvent> = sts.closedEnum(() => {
    return  {
        ArbitrageExecuted: sts.enumStruct({
            assetId: sts.number(),
            hollarAmount: sts.bigint(),
        }),
        CollateralAdded: sts.enumStruct({
            assetId: sts.number(),
            poolId: sts.number(),
            purchaseFee: Permill,
            maxBuyPriceCoefficient: FixedU128,
        ...
        CollateralRemoved: sts.enumStruct({
            assetId: sts.number(),
            amount: sts.bigint(),
        }),
        CollateralUpdated: sts.enumStruct({
            assetId: sts.number(),
