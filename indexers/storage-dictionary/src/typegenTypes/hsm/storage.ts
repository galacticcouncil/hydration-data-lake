...
export const collaterals =  {
     ...
     */
    v323: new StorageType('HSM.Collaterals', 'Optional', [sts.number()], v323.CollateralInfo) as CollateralsV323,
}
 ...
 *  Each collateral has specific parameters controlling its usage in the HSM mechanism.
 */
export interface CollateralsV323  {
    is(block: RuntimeCtx): boolean
    get(block: Block, key: number): Promise<(v323.CollateralInfo | undefined)>
    getMany(block: Block, keys: number[]): Promise<(v323.CollateralInfo | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: (v323.CollateralInfo | undefined)][]>
    getPairs(block: Block, key: number): Promise<[k: number, v: (v323.CollateralInfo | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: (v323.CollateralInfo | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v323.CollateralInfo | undefined)][]>
}
...
export const hollarAmountReceived =  {
     ...
     */
    v323: new StorageType('HSM.HollarAmountReceived', 'Default', [sts.number()], sts.bigint()) as HollarAmountReceivedV323,
}
 ...
 *  Values are reset to zero at the end of each block in on_finalize.
 */
export interface HollarAmountReceivedV323  {
    is(block: RuntimeCtx): boolean
...
export const flashMinter =  {
     ...
     */
    v323: new StorageType('HSM.FlashMinter', 'Optional', [], v323.H160) as FlashMinterV323,
}

/**
 *  Address of the flash loan receiver.
 */
export interface FlashMinterV323  {
    is(block: RuntimeCtx): boolean
    get(block: Block): Promise<(v323.H160 | undefined)>
}
