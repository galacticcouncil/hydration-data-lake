...
export type Event = Event_AssetRegistry | Event_Balances | Event_Bonds | Event_CircuitBreaker | Event_Claims | Event_CollatorRewards | Event_CollatorSelection | Event_Council | Event_CumulusXcm | Event_Currencies | Event_DCA | Event_Democracy | Event_DmpQueue | Event_Duster | Event_DynamicFees | Event_EVM | Event_EVMAccounts | Event_Elections | Event_EmaOracle | Event_Ethereum | Event_Identity | Event_LBP | Event_MultiTransactionPayment | Event_Multisig | Event_OTC | Event_Omnipool | Event_OmnipoolLiquidityMining | Event_OmnipoolWarehouseLM | Event_OrmlXcm | Event_ParachainSystem | Event_PolkadotXcm | Event_Preimage | Event_Proxy | Event_Referrals | Event_RelayChainInfo | Event_Router | Event_Scheduler | Event_Session | Event_Stableswap | Event_Staking | Event_StateTrieMigration | Event_System | Event_TechnicalCommittee | Event_Tips | Event_Tokens | Event_TransactionPause | Event_TransactionPayment | Event_Treasury | Event_Uniques | Event_UnknownTokens | Event_Utility | Event_Vesting | Event_XTokens | Event_XYK | Event_XYKLiquidityMining | Event_XYKWarehouseLM | Event_XcmRateLimiter | Event_XcmpQueue
 ...
 * The `Event` enum of this pallet
 */
export type EVMAccountsEvent = EVMAccountsEvent_Bound | EVMAccountsEvent_DeployerAdded | EVMAccountsEvent_DeployerRemoved
...
export const Type_117: sts.Type<Type_117> = sts.struct(() => {
    return  {
        assetId: sts.number(),
        amount: sts.bigint(),
    }
