...
export type SkipEd = SkipEd_Lock | SkipEd_LockAndUnlock | SkipEd_Unlock

export interface SkipEd_Lock {
    __kind: 'Lock'
}

export interface SkipEd_LockAndUnlock {
    __kind: 'LockAndUnlock'
}

export interface SkipEd_Unlock {
    __kind: 'Unlock'
}

export const SkipEd: sts.Type<SkipEd> = sts.closedEnum(() => {
    return  {
        Lock: sts.unit(),
        LockAndUnlock: sts.unit(),
        Unlock: sts.unit(),
    }
})
