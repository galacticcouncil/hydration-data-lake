...
export const Type_170: sts.Type<Type_170> = sts.struct(() => {
    return  {
...
export type Event = Event_AssetRegistry | Event_Balances | Event_CircuitBreaker | Event_Claims | Event_CollatorRewards | Event_CollatorSelection | Event_Council | Event_CumulusXcm | Event_Currencies | Event_DCA | Event_Democracy | Event_DmpQueue | Event_Duster | Event_Elections | Event_EmaOracle | Event_Identity | Event_MultiTransactionPayment | Event_Multisig | Event_OTC | Event_Omnipool | Event_OmnipoolLiquidityMining | Event_OmnipoolWarehouseLM | Event_OrmlXcm | Event_ParachainSystem | Event_PolkadotXcm | Event_Preimage | Event_Proxy | Event_RelayChainInfo | Event_Router | Event_Scheduler | Event_Session | Event_System | Event_TechnicalCommittee | Event_Tips | Event_Tokens | Event_TransactionPause | Event_TransactionPayment | Event_Treasury | Event_Uniques | Event_UnknownTokens | Event_Utility | Event_Vesting | Event_XTokens | Event_XcmpQueue
