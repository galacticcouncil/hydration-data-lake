...
**Examples of environment variable usage can be found in the [SQD cloud deployment manifest files](deployment-lbp-pool.yaml) and [Docker Swarm stack files](../../self-hosted/storage-dictionary-indexer/legacy/storage-dictionary-multiprocessor.stack.ymlack.yml).**
