...
export const burn =  {
    ...
    v324: new CallType(
        ...
        sts.struct({
            collection: sts.bigint(),
            item: sts.bigint(),
            checkOwner: sts.option(() => v324.AccountId32),
        })
    ),
}
...
export const setTeam =  {
    ...
    v324: new CallType(
        ...
        sts.struct({
            collection: sts.bigint(),
            issuer: v324.AccountId32,
            admin: v324.AccountId32,
            freezer: v324.AccountId32,
        })
    ),
}
...
export const cancelApproval =  {
    ...
    v324: new CallType(
        ...
        sts.struct({
            collection: sts.bigint(),
            item: sts.bigint(),
            maybeCheckDelegate: sts.option(() => v324.AccountId32),
        })
    ),
}
...
export const setPrice =  {
    ...
    v324: new CallType(
        ...
        sts.struct({
            ...
            whitelistedBuyer: sts.option(() => v324.AccountId32),
        })
    ),
}
