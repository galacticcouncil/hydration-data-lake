 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const AmmSupportCall: sts.Type<AmmSupportCall> = sts.closedEnum(() => {
    return  {
    }
})
