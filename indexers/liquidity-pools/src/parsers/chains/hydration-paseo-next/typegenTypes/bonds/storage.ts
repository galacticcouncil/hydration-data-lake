...
export const bondIds =  {
     ...
     */
    v324: new StorageType('Bonds.BondIds', 'Optional', [sts.tuple(() => [sts.number(), sts.bigint()])], sts.number()) as BondIdsV324,
}
...
export const bonds =  {
     ...
     */
    v324: new StorageType('Bonds.Bonds', 'Optional', [sts.number()], sts.tuple(() => [sts.number(), sts.bigint()])) as BondsV324,
}
