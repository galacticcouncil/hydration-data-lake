...
export const burn =  {
    ...
    v405: new CallType(
        ...
        sts.struct({
            collection: sts.bigint(),
            item: sts.bigint(),
            checkOwner: sts.option(() => v405.AccountId32),
        })
    ),
}
...
export const setTeam =  {
    ...
    v405: new CallType(
        ...
        sts.struct({
            collection: sts.bigint(),
            issuer: v405.AccountId32,
            admin: v405.AccountId32,
            freezer: v405.AccountId32,
        })
    ),
}
...
export const cancelApproval =  {
    ...
    v405: new CallType(
        ...
        sts.struct({
            collection: sts.bigint(),
            item: sts.bigint(),
            maybeCheckDelegate: sts.option(() => v405.AccountId32),
        })
    ),
}
...
export const setPrice =  {
    ...
    v405: new CallType(
        ...
        sts.struct({
            ...
            whitelistedBuyer: sts.option(() => v405.AccountId32),
        })
    ),
}
