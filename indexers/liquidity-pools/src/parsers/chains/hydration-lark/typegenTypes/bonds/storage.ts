...
export const bondIds =  {
     ...
     */
    v405: new StorageType('Bonds.BondIds', 'Optional', [sts.tuple(() => [sts.number(), sts.bigint()])], sts.number()) as BondIdsV405,
}
...
export const bonds =  {
     ...
     */
    v405: new StorageType('Bonds.Bonds', 'Optional', [sts.number()], sts.tuple(() => [sts.number(), sts.bigint()])) as BondsV405,
}
