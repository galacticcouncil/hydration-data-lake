...
export const Call: sts.Type<Call> = sts.closedEnum(() => {
    return  {
        ...
        FeeProcessor: FeeProcessorCall,
        GenesisHistory: GenesisHistoryCall,
        GigaHdx: GigaHdxCall,
        GigaHdxVoting: GigaHdxVotingCall,
        HSM: HSMCall,
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type ReferralsCall = ReferralsCall_claim_rewards | ReferralsCall_link_code | ReferralsCall_register_code | ReferralsCall_set_reward_percentage
...
export const LiquidationCall: sts.Type<LiquidationCall> = sts.closedEnum(() => {
    return  {
        ...
        set_gigahdx_pool_contract: sts.enumStruct({
            contract: H160,
        }),
    }
})
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type LiquidationCall = LiquidationCall_liquidate | LiquidationCall_set_borrowing_contract | LiquidationCall_set_gigahdx_pool_contract
 ...
 */
export interface LiquidationCall_set_gigahdx_pool_contract {
    __kind: 'set_gigahdx_pool_contract'
    contract: H160
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const GigaHdxVotingCall: sts.Type<GigaHdxVotingCall> = sts.closedEnum(() => {
    return  {
        claim_rewards: sts.unit(),
    }
})
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type GigaHdxVotingCall = GigaHdxVotingCall_claim_rewards
 ...
 */
export interface GigaHdxVotingCall_claim_rewards {
    __kind: 'claim_rewards'
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const GigaHdxCall: sts.Type<GigaHdxCall> = sts.closedEnum(() => {
    return  {
        giga_stake: sts.enumStruct({
            hdxAmount: sts.bigint(),
        }),
        giga_unstake: sts.enumStruct({
            gigahdxAmount: sts.bigint(),
        }),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type GigaHdxCall = GigaHdxCall_giga_stake | GigaHdxCall_giga_unstake | GigaHdxCall_unlock
 ...
 */
export interface GigaHdxCall_giga_stake {
    __kind: 'giga_stake'
    hdxAmount: bigint
}
 ...
 */
export interface GigaHdxCall_giga_unstake {
    __kind: 'giga_unstake'
    gigahdxAmount: bigint
}
 ...
 */
export interface GigaHdxCall_unlock {
    __kind: 'unlock'
    target: AccountId32
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const FeeProcessorCall: sts.Type<FeeProcessorCall> = sts.closedEnum(() => {
    return  {
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type FeeProcessorCall = FeeProcessorCall_convert

/**
 * Manual conversion trigger. Permissionless.
 */
export interface FeeProcessorCall_convert {
    __kind: 'convert'
    assetId: number
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type DispatcherCall = DispatcherCall_dispatch_as_aave_manager | DispatcherCall_dispatch_as_emergency_admin | DispatcherCall_dispatch_as_treasury | DispatcherCall_dispatch_evm_call | DispatcherCall_dispatch_with_extra_gas | DispatcherCall_note_aave_manager
...
export interface Call_FeeProcessor {
    __kind: 'FeeProcessor'
    value: FeeProcessorCall
}
...
export interface Call_GigaHdx {
    __kind: 'GigaHdx'
    value: GigaHdxCall
}

export interface Call_GigaHdxVoting {
    __kind: 'GigaHdxVoting'
    value: GigaHdxVotingCall
}
