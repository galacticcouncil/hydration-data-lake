...
export interface Type_803 {
    shares: bigint
    ammPoolId: AccountId32
    yieldFarmEntries: Type_805[]
}

export interface Type_805 {
    globalFarmId: number
    yieldFarmId: number
    valuedShares: bigint
...
export const Type_803: sts.Type<Type_803> = sts.struct(() => {
    return  {
        shares: sts.bigint(),
        ammPoolId: AccountId32,
        yieldFarmEntries: sts.array(() => Type_805),
    }
})

export const Type_805: sts.Type<Type_805> = sts.struct(() => {
    return  {
...
export const Type_800: sts.Type<Type_800> = sts.struct(() => {
    return  {
        id: sts.number(),
        owner: AccountId32,
        updatedAt: sts.number(),
...
export interface Type_770 {
    free: bigint
    reserved: bigint
    frozen: bigint
}

export const Type_770: sts.Type<Type_770> = sts.struct(() => {
    return  {
        free: sts.bigint(),
        reserved: sts.bigint(),
        frozen: sts.bigint(),
...
export type SignedBalance = SignedBalance_Negative | SignedBalance_Positive
...
export const SignedBalance: sts.Type<SignedBalance> = sts.closedEnum(() => {
    return  {
        Negative: sts.bigint(),
        Positive: sts.bigint(),
    }
...
export type RuntimeHoldReason = RuntimeHoldReason_PolkadotXcm | RuntimeHoldReason_Preimage | RuntimeHoldReason_StateTrieMigration | RuntimeHoldReason_TechnicalCommittee
...
export type Type_581 = Type_581_ProposalSubmission

export interface Type_581_ProposalSubmission {
    __kind: 'ProposalSubmission'
}

export type Type_582 = Type_582_SlashForMigrate

export interface Type_582_SlashForMigrate {
...
export type Type_583 = Type_583_AuthorizeAlias

export interface Type_583_AuthorizeAlias {
...
export const RuntimeHoldReason: sts.Type<RuntimeHoldReason> = sts.closedEnum(() => {
    return  {
        PolkadotXcm: Type_583,
        Preimage: HoldReason,
        StateTrieMigration: Type_582,
        TechnicalCommittee: Type_581,
    }
})

export const Type_581: sts.Type<Type_581> = sts.closedEnum(() => {
    return  {
...
export const Type_583: sts.Type<Type_583> = sts.closedEnum(() => {
    return  {
