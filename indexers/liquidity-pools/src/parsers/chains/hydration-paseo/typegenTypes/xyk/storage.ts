...
export const shareToken =  {
     ...
     */
    v257: new StorageType('XYK.ShareToken', 'Default', [v257.AccountId32], sts.number()) as ShareTokenV257,
}

/**
 *  Asset id storage for shared pool tokens
 */
export interface ShareTokenV257  {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): number
    get(block: Block, key: v257.AccountId32): Promise<(number | undefined)>
    getMany(block: Block, keys: v257.AccountId32[]): Promise<(number | undefined)[]>
    ...
    getPairs(block: Block): Promise<[k: v257.AccountId32, v: (number | undefined)][]>
    getPairs(block: Block, key: v257.AccountId32): Promise<[k: v257.AccountId32, v: (number | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v257.AccountId32, v: (number | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v257.AccountId32): AsyncIterable<[k: v257.AccountId32, v: (number | undefined)][]>
}
