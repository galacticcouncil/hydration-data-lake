...
export type Type_91 = Type_91_Member | Type_91_Members | Type_91__Phantom

export interface Type_91_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_91_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_91__Phantom {
    __kind: '_Phantom'
}
...
export type Type_94 = Type_94_Response | Type_94_Xcm

export interface Type_94_Response {
    __kind: 'Response'
    value: V4Location
}

export interface Type_94_Xcm {
    __kind: 'Xcm'
    value: V4Location
}
...
export const SignetCall: sts.Type<SignetCall> = sts.closedEnum(() => {
    return  {
        ...
        sign_respond: sts.enumStruct({
            serializedTransaction: sts.bytes(),
            slip44ChainId: sts.number(),
            keyVersion: sts.number(),
            path: sts.bytes(),
            algo: sts.bytes(),
            dest: sts.bytes(),
            params: sts.bytes(),
            explorerDeserializationFormat: SerializationFormat,
            explorerDeserializationSchema: sts.bytes(),
            callbackSerializationFormat: SerializationFormat,
            callbackSerializationSchema: sts.bytes(),
        }),
...
export const SerializationFormat: sts.Type<SerializationFormat> = sts.closedEnum(() => {
    return  {
        AbiJson: sts.unit(),
        Borsh: sts.unit(),
    }
...
export type SerializationFormat = SerializationFormat_AbiJson | SerializationFormat_Borsh

export interface SerializationFormat_AbiJson {
    __kind: 'AbiJson'
}

export interface SerializationFormat_Borsh {
    __kind: 'Borsh'
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type SignetCall = SignetCall_initialize | SignetCall_read_respond | SignetCall_respond | SignetCall_respond_error | SignetCall_sign | SignetCall_sign_respond | SignetCall_update_deposit | SignetCall_withdraw_funds
 ...
 */
export interface SignetCall_read_respond {
    __kind: 'read_respond'
    requestId: Bytes
 ...
 */
export interface SignetCall_sign_respond {
    __kind: 'sign_respond'
...
export const Type_399: sts.Type<Type_399> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_402),
        V3: sts.array(() => Type_406),
        V4: sts.array(() => Type_409),
    }
})
...
export const Type_409: sts.Type<Type_409> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V4Asset),
        SetAppendix: sts.array(() => Type_409),
        SetErrorHandler: sts.array(() => Type_409),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_403: sts.Type<Type_403> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})

export interface Type_403 {
    encoded: Bytes
}

export type Type_409 = Type_409_AliasOrigin | Type_409_BurnAsset | Type_409_BuyExecution | Type_409_ClaimAsset | Type_409_ClearError | Type_409_ClearOrigin | Type_409_ClearTopic | Type_409_ClearTransactStatus | Type_409_DepositAsset | Type_409_DepositReserveAsset | Type_409_DescendOrigin | Type_409_ExchangeAsset | Type_409_ExpectAsset | Type_409_ExpectError | Type_409_ExpectOrigin | Type_409_ExpectPallet | Type_409_ExpectTransactStatus | Type_409_ExportMessage | Type_409_HrmpChannelAccepted | Type_409_HrmpChannelClosing | Type_409_HrmpNewChannelOpenRequest | Type_409_InitiateReserveWithdraw | Type_409_InitiateTeleport | Type_409_LockAsset | Type_409_NoteUnlockable | Type_409_QueryPallet | Type_409_QueryResponse | Type_409_ReceiveTeleportedAsset | Type_409_RefundSurplus | Type_409_ReportError | Type_409_ReportHolding | Type_409_ReportTransactStatus | Type_409_RequestUnlock | Type_409_ReserveAssetDeposited | Type_409_SetAppendix | Type_409_SetErrorHandler | Type_409_SetFeesMode | Type_409_SetTopic | Type_409_SubscribeVersion | Type_409_Transact | Type_409_TransferAsset | Type_409_TransferReserveAsset | Type_409_Trap | Type_409_UniversalOrigin | Type_409_UnlockAsset | Type_409_UnpaidExecution | Type_409_UnsubscribeVersion | Type_409_WithdrawAsset

export interface Type_409_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V4Location
}

export interface Type_409_BurnAsset {
    __kind: 'BurnAsset'
    value: V4Asset[]
}

export interface Type_409_BuyExecution {
    __kind: 'BuyExecution'
    fees: V4Asset
    weightLimit: V3WeightLimit
}

export interface Type_409_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V4Asset[]
    ticket: V4Location
}

export interface Type_409_ClearError {
    __kind: 'ClearError'
}

export interface Type_409_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_409_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_409_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_409_DepositAsset {
    __kind: 'DepositAsset'
    assets: V4AssetFilter
    beneficiary: V4Location
}

export interface Type_409_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V4AssetFilter
    dest: V4Location
    xcm: V4Instruction[]
...
export interface Type_409_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V4Junctions
}

export interface Type_409_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V4AssetFilter
    want: V4Asset[]
    maximal: boolean
...
export interface Type_409_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V4Asset[]
}

export interface Type_409_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_409_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V4Location | undefined)
}

export interface Type_409_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_409_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_409_ExportMessage {
    __kind: 'ExportMessage'
    network: V4NetworkId
    destination: V4Junctions
    xcm: V4Instruction[]
...
export interface Type_409_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V4AssetFilter
    reserve: V4Location
    xcm: V4Instruction[]
...
export interface Type_409_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V4AssetFilter
    dest: V4Location
    xcm: V4Instruction[]
...
export interface Type_409_LockAsset {
    __kind: 'LockAsset'
    asset: V4Asset
    unlocker: V4Location
}

export interface Type_409_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V4Asset
    owner: V4Location
}

export interface Type_409_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V4QueryResponseInfo
}
...
export interface Type_409_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V4Asset[]
}

export interface Type_409_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_409_ReportError {
    __kind: 'ReportError'
    value: V4QueryResponseInfo
}

export interface Type_409_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V4QueryResponseInfo
    assets: V4AssetFilter
}

export interface Type_409_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V4QueryResponseInfo
}

export interface Type_409_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V4Asset
    locker: V4Location
}

export interface Type_409_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V4Asset[]
}

export interface Type_409_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_409[]
}

export interface Type_409_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_409[]
}

export interface Type_409_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_409_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_409_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}
...
export interface Type_409_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_409_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V4Junction
}

export interface Type_409_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V4Asset
    target: V4Location
}

export interface Type_409_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V4Location | undefined)
}

export interface Type_409_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}
...
export const Type_406: sts.Type<Type_406> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_406),
        SetErrorHandler: sts.array(() => Type_406),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export type Type_406 = Type_406_AliasOrigin | Type_406_BurnAsset | Type_406_BuyExecution | Type_406_ClaimAsset | Type_406_ClearError | Type_406_ClearOrigin | Type_406_ClearTopic | Type_406_ClearTransactStatus | Type_406_DepositAsset | Type_406_DepositReserveAsset | Type_406_DescendOrigin | Type_406_ExchangeAsset | Type_406_ExpectAsset | Type_406_ExpectError | Type_406_ExpectOrigin | Type_406_ExpectPallet | Type_406_ExpectTransactStatus | Type_406_ExportMessage | Type_406_HrmpChannelAccepted | Type_406_HrmpChannelClosing | Type_406_HrmpNewChannelOpenRequest | Type_406_InitiateReserveWithdraw | Type_406_InitiateTeleport | Type_406_LockAsset | Type_406_NoteUnlockable | Type_406_QueryPallet | Type_406_QueryResponse | Type_406_ReceiveTeleportedAsset | Type_406_RefundSurplus | Type_406_ReportError | Type_406_ReportHolding | Type_406_ReportTransactStatus | Type_406_RequestUnlock | Type_406_ReserveAssetDeposited | Type_406_SetAppendix | Type_406_SetErrorHandler | Type_406_SetFeesMode | Type_406_SetTopic | Type_406_SubscribeVersion | Type_406_Transact | Type_406_TransferAsset | Type_406_TransferReserveAsset | Type_406_Trap | Type_406_UniversalOrigin | Type_406_UnlockAsset | Type_406_UnpaidExecution | Type_406_UnsubscribeVersion | Type_406_WithdrawAsset

export interface Type_406_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_406_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}

export interface Type_406_BuyExecution {
    __kind: 'BuyExecution'
    fees: V3MultiAsset
    weightLimit: V3WeightLimit
}

export interface Type_406_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_406_ClearError {
    __kind: 'ClearError'
}

export interface Type_406_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_406_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_406_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_406_DepositAsset {
    __kind: 'DepositAsset'
    assets: V3MultiAssetFilter
    beneficiary: V3MultiLocation
}

export interface Type_406_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_406_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}

export interface Type_406_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V3MultiAssetFilter
    want: V3MultiAsset[]
    maximal: boolean
...
export interface Type_406_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_406_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_406_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_406_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_406_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_406_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_406_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_406_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_406_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_406_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V3MultiAssetFilter
    reserve: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_406_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_406_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_406_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_406_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}

export interface Type_406_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V3Response
    maxWeight: Weight
...
export interface Type_406_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V3MultiAsset[]
}

export interface Type_406_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_406_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_406_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_406_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_406_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_406_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V3MultiAsset[]
}

export interface Type_406_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_406[]
}

export interface Type_406_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_406[]
}

export interface Type_406_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_406_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_406_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_406_Transact {
    __kind: 'Transact'
    originKind: V3OriginKind
    requireWeightAtMost: Weight
    call: Type_403
...
export interface Type_406_TransferAsset {
    __kind: 'TransferAsset'
    assets: V3MultiAsset[]
    beneficiary: V3MultiLocation
}

export interface Type_406_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V3MultiAsset[]
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_406_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_406_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_406_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_406_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}

export interface Type_406_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_406_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V3MultiAsset[]
}
...
export const Type_402: sts.Type<Type_402> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_402),
        SetErrorHandler: sts.array(() => Type_402),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_402 = Type_402_BuyExecution | Type_402_ClaimAsset | Type_402_ClearError | Type_402_ClearOrigin | Type_402_DepositAsset | Type_402_DepositReserveAsset | Type_402_DescendOrigin | Type_402_ExchangeAsset | Type_402_HrmpChannelAccepted | Type_402_HrmpChannelClosing | Type_402_HrmpNewChannelOpenRequest | Type_402_InitiateReserveWithdraw | Type_402_InitiateTeleport | Type_402_QueryHolding | Type_402_QueryResponse | Type_402_ReceiveTeleportedAsset | Type_402_RefundSurplus | Type_402_ReportError | Type_402_ReserveAssetDeposited | Type_402_SetAppendix | Type_402_SetErrorHandler | Type_402_SubscribeVersion | Type_402_Transact | Type_402_TransferAsset | Type_402_TransferReserveAsset | Type_402_Trap | Type_402_UnsubscribeVersion | Type_402_WithdrawAsset

export interface Type_402_BuyExecution {
    __kind: 'BuyExecution'
    fees: V2MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_402_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_402_ClearError {
    __kind: 'ClearError'
}

export interface Type_402_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_402_DepositAsset {
    __kind: 'DepositAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    beneficiary: V2MultiLocation
...
export interface Type_402_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    dest: V2MultiLocation
...
export interface Type_402_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}

export interface Type_402_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V2MultiAssetFilter
    receive: V2MultiAsset[]
}

export interface Type_402_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_402_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_402_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_402_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V2MultiAssetFilter
    reserve: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_402_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V2MultiAssetFilter
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_402_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export interface Type_402_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_402_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V2MultiAsset[]
}

export interface Type_402_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_402_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V2MultiLocation
    maxResponseWeight: bigint
...
export interface Type_402_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V2MultiAsset[]
}

export interface Type_402_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_402[]
}

export interface Type_402_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_402[]
}

export interface Type_402_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_402_Transact {
    __kind: 'Transact'
    originType: V2OriginKind
    requireWeightAtMost: bigint
    call: Type_403
...
export interface Type_402_TransferAsset {
    __kind: 'TransferAsset'
    assets: V2MultiAsset[]
    beneficiary: V2MultiLocation
}

export interface Type_402_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V2MultiAsset[]
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_402_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_402_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_402_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V2MultiAsset[]
}

export type Type_399 = Type_399_V2 | Type_399_V3 | Type_399_V4

export interface Type_399_V2 {
    __kind: 'V2'
    value: Type_402[]
}

export interface Type_399_V3 {
    __kind: 'V3'
    value: Type_406[]
}

export interface Type_399_V4 {
    __kind: 'V4'
    value: Type_409[]
}
...
export type Type_64 = Type_64_Split | Type_64_SplitAbstain | Type_64_Standard

export interface Type_64_Split {
    __kind: 'Split'
    aye: bigint
    nay: bigint
}

export interface Type_64_SplitAbstain {
    __kind: 'SplitAbstain'
    aye: bigint
    nay: bigint
    abstain: bigint
...
export interface Type_64_Standard {
    __kind: 'Standard'
    vote: number
    balance: bigint
}
...
export type Type_176 = Type_176_Locked1x | Type_176_Locked2x | Type_176_Locked3x | Type_176_Locked4x | Type_176_Locked5x | Type_176_Locked6x | Type_176_None

export interface Type_176_Locked1x {
    __kind: 'Locked1x'
}

export interface Type_176_Locked2x {
    __kind: 'Locked2x'
}

export interface Type_176_Locked3x {
    __kind: 'Locked3x'
}

export interface Type_176_Locked4x {
    __kind: 'Locked4x'
}

export interface Type_176_Locked5x {
    __kind: 'Locked5x'
}

export interface Type_176_Locked6x {
    __kind: 'Locked6x'
}

export interface Type_176_None {
    __kind: 'None'
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type CircuitBreakerCall = CircuitBreakerCall_force_lift_lockdown | CircuitBreakerCall_lockdown_asset | CircuitBreakerCall_release_deposit | CircuitBreakerCall_set_add_liquidity_limit | CircuitBreakerCall_set_remove_liquidity_limit | CircuitBreakerCall_set_trade_volume_limit
