...
export const assetLocations =  {
     ...
     *  Native location of an asset.
     */
    v390: new StorageType('AssetRegistry.AssetLocations', 'Optional', [sts.number()], v390.AssetLocation) as AssetLocationsV390,
}
 ...
 *  Native location of an asset.
 */
export interface AssetLocationsV390  {
    is(block: RuntimeCtx): boolean
    get(block: Block, key: number): Promise<(v390.AssetLocation | undefined)>
    getMany(block: Block, keys: number[]): Promise<(v390.AssetLocation | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: (v390.AssetLocation | undefined)][]>
    getPairs(block: Block, key: number): Promise<[k: number, v: (v390.AssetLocation | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: (v390.AssetLocation | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v390.AssetLocation | undefined)][]>
}
