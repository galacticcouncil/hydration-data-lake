...
export class StableswapLifeState {
  private _created!: StableswapCreatedData;
  private _destroyed!: StableswapDestroyedData | undefined | null;

  constructor(
    props?: Partial<Omit<StableswapLifeState, 'toJSON'>>,
    json?: any
  ) {
    Object.assign(this, props);
    if (json != null) {
      this._created = new StableswapCreatedData(
        undefined,
        marshal.nonNull(json.created)
      );
      this._destroyed =
        json.destroyed == null
          ? undefined
          : new StableswapDestroyedData(undefined, json.destroyed);
    }
  }
