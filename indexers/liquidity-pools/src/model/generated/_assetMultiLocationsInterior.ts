...
export class AssetMultiLocationsInterior {
  ...
  constructor(
    props?: Partial<Omit<AssetMultiLocationsInterior, 'toJSON'>>,
    json?: any
  ) {
    Object.assign(this, props);
    if (json != null) {
      this._kind = marshal.enumFromJson(
        json.kind,
      ...
      this._network =
        json.network == null
          ? undefined
          : marshal.string.fromJSON(json.network);
      this._id = json.id == null ? undefined : marshal.string.fromJSON(json.id);
      this._index =
        json.index == null ? undefined : marshal.string.fromJSON(json.index);
      this._key =
        json.key == null ? undefined : marshal.string.fromJSON(json.key);
      this._value =
        json.value == null ? undefined : marshal.string.fromJSON(json.value);
      this._valueJson = json.valueJson;
      this._data =
        json.data == null ? undefined : marshal.string.fromJSON(json.data);
      this._part =
        json.part == null ? undefined : marshal.string.fromJSON(json.part);
      this._nom =
        json.nom == null ? undefined : marshal.string.fromJSON(json.nom);
      this._denom =
        json.denom == null ? undefined : marshal.string.fromJSON(json.denom);
      this._count =
        json.count == null ? undefined : marshal.string.fromJSON(json.count);
      this._blockNumber =
        json.blockNumber == null
          ? undefined
          : marshal.string.fromJSON(json.blockNumber);
      this._blockHash =
        json.blockHash == null
          ? undefined
          : marshal.string.fromJSON(json.blockHash);
      this._chainId =
        json.chainId == null
          ? undefined
          : marshal.string.fromJSON(json.chainId);
    }
  }
