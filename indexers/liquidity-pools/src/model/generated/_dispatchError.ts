...
export class DispatchError {
  ...
  constructor(props?: Partial<Omit<DispatchError, 'toJSON'>>, json?: any) {
    ...
    if (json != null) {
      this._kind =
        json.kind == null ? undefined : marshal.string.fromJSON(json.kind);
      this._index =
        json.index == null ? undefined : marshal.int.fromJSON(json.index);
      this._error =
        json.error == null ? undefined : marshal.string.fromJSON(json.error);
    }
  }
