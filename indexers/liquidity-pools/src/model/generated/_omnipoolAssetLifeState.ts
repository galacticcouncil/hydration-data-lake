...
export class OmnipoolAssetLifeState {
  ...
  constructor(
    props?: Partial<Omit<OmnipoolAssetLifeState, 'toJSON'>>,
    json?: any
  ) {
    Object.assign(this, props);
    if (json != null) {
      this._added = new OmnipoolAssetAddedData(
        undefined,
        marshal.nonNull(json.added)
      );
      this._removed =
        json.removed == null
          ? undefined
          : new OmnipoolAssetRemovedData(undefined, json.removed);
    }
  }
