...
export class OperationStackElementOmnipool {
  public readonly isTypeOf = 'OperationStackElementOmnipool'
  private _index!: number
  private _kind!: SwappedExecutionTypeKind
  private _incrementalId!: number

  constructor(props?: Partial<Omit<OperationStackElementOmnipool, 'toJSON'>>, json?: any) {
