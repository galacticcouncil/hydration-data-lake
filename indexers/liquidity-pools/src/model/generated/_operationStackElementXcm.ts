...
export class OperationStackElementXcm {
  public readonly isTypeOf = 'OperationStackElementXcm'
  private _index!: number
  private _kind!: SwappedExecutionTypeKind
  private _incrementalId!: number
  private _message!: string

  constructor(props?: Partial<Omit<OperationStackElementXcm, 'toJSON'>>, json?: any) {
    ...
    if (json != null) {
      ...
      this._message = marshal.string.fromJSON(json.message)
    }
  }
  ...
  get message(): string {
    assert(this._message != null, 'uninitialized access')
