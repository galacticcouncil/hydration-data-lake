...
export class StableswapPegsSource {
  ...
  constructor(
    props?: Partial<Omit<StableswapPegsSource, 'toJSON'>>,
    json?: any
  ) {
    ...
    if (json != null) {
      ...
      this._oracleName =
        json.oracleName == null
          ? undefined
          : marshal.string.fromJSON(json.oracleName);
      this._oraclePeriod =
        json.oraclePeriod == null
          ? undefined
          : marshal.enumFromJson(json.oraclePeriod, EmaOraclePeriod);
      this._oracleAsset =
        json.oracleAsset == null
          ? undefined
          : marshal.string.fromJSON(json.oracleAsset);
      this._valuePoints =
        json.valuePoints == null
          ? undefined
          : marshal.fromList(json.valuePoints, (val) =>
              marshal.string.fromJSON(val)
            );
    }
  }
