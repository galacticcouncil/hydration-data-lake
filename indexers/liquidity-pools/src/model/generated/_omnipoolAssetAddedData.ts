...
export class OmnipoolAssetAddedData {
  ...
  constructor(
    props?: Partial<Omit<OmnipoolAssetAddedData, 'toJSON'>>,
    json?: any
  ) {
    Object.assign(this, props);
    if (json != null) {
      this._initialAmount =
        json.initialAmount == null
          ? undefined
          : marshal.string.fromJSON(json.initialAmount);
      this._initialPrice =
        json.initialPrice == null
          ? undefined
          : marshal.string.fromJSON(json.initialPrice);
      this._eventId =
        json.eventId == null
          ? undefined
