...
export class OmnipoolAssetRemovedData {
  ...
  constructor(
    props?: Partial<Omit<OmnipoolAssetRemovedData, 'toJSON'>>,
    json?: any
  ) {
    Object.assign(this, props);
    if (json != null) {
      this._removedAmount =
        json.removedAmount == null
          ? undefined
          : marshal.string.fromJSON(json.removedAmount);
      this._hubWithdrawn =
        json.hubWithdrawn == null
          ? undefined
          : marshal.string.fromJSON(json.hubWithdrawn);
      this._eventId =
        json.eventId == null
          ? undefined
