...
export class OperationStackElementRouter {
  public readonly isTypeOf = 'OperationStackElementRouter'
  private _index!: number
  private _kind!: SwappedExecutionTypeKind
  private _incrementalId!: number

  constructor(props?: Partial<Omit<OperationStackElementRouter, 'toJSON'>>, json?: any) {
