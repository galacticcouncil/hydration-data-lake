...
export class YieldFarmLoyaltyCurve {
    ...
    constructor(props?: Partial<Omit<YieldFarmLoyaltyCurve, 'toJSON'>>, json?: any) {
        Object.assign(this, props)
        if (json != null) {
            this._initialRewardPercentage = marshal.string.fromJSON(json.initialRewardPercentage)
