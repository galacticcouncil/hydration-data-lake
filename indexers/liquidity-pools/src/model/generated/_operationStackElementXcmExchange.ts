...
export class OperationStackElementXcmExchange {
  public readonly isTypeOf = 'OperationStackElementXcmExchange'
  private _index!: number
  private _kind!: SwappedExecutionTypeKind
  private _incrementalId!: number

  constructor(props?: Partial<Omit<OperationStackElementXcmExchange, 'toJSON'>>, json?: any) {
