...
//
// export const aggregateXykPoolVolumesByBlocksRange = `
//     WITH pool_start_block AS (SELECT id,
//                                      pool_id,
//                                      asset_a_id,
...
//
//                                      asset_a_vol_in_norm,
//                                      asset_a_vol_out_norm,
//                                      asset_b_vol_in_norm,
//                                      asset_b_vol_out_norm,
//                                      asset_a_fee_vol_norm,
//                                      asset_b_fee_vol_norm,
//
//                                      asset_a_total_vol_in_norm,
//                                      asset_a_total_vol_out_norm,
//                                      asset_b_total_vol_in_norm,
//                                      asset_b_total_vol_out_norm,
//                                      asset_a_fees_total_vol_norm,
//                                      asset_b_fees_total_vol_norm,
//
//                                      para_block_height,
//                                      ROW_NUMBER() OVER (PARTITION BY pool_id ORDER BY para_block_height ASC) AS rank
//                               FROM xykpool_volume_historical_data
...
//                                    asset_a_fee_vol_in,
//                                    asset_a_fee_vol_out,
//                                    asset_a_fees_total_vol_in,
//                                    asset_a_fees_total_vol_out,
//
//                                    asset_b_id,
//                                    asset_b_registry_id: asset_b.asset_registry_id,
//                                    asset_b_vol_in,
...
//                                    asset_b_fee_vol_in,
//                                    asset_b_fee_vol_out,
//                                    asset_b_fees_total_vol_in,
//                                    asset_b_fees_total_vol_out,
//
//                                    asset_a_vol_in_norm,
//                                    asset_a_vol_out_norm,
//                                    asset_b_vol_in_norm,
