...
export class AaveMoneyMarketManager {
  private static instance: AaveMoneyMarketManager;
  ...
  static getInstance(): AaveMoneyMarketManager {
    if (!AaveMoneyMarketManager.instance) {
      AaveMoneyMarketManager.instance =
        new AaveMoneyMarketManager();
    }
    return AaveMoneyMarketManager.instance;
  }
